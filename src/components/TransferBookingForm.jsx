                            ...
                            <>
                                <div className='mb-5'>
                                    <label className='flex items-center justify-center'>
                                        ...
                                        <span className="ml-2 text-gray-700">{getLabel("iAccept")} <Link title="Vai a termini e conidzioni" className='capitalize underline' href="/terms-and-conditions">{getLabel("termsConditions")}</Link></span>
                                    </label>
                                </div>
